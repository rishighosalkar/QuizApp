...
namespace QuizApi.Controllers
{
    ...
    public class QuestionController : Controller
    {
        ...
        [HttpPost]
        [Route("AddQuestion")]
        public async Task<ActionResult<Participant>> PostQuestion(Question question)
        {
            var temp = _context.Questions.Where(x => x.QnInWords ==question.QnInWords).FirstOrDefault();
            if (temp == null)
            {
